...
Sales Performance Dashboard: Developed an interactive sales dashboard using Python (Pandas, Matplotlib) to visualize key KPIs in real-time, helping leadership make informed decisions at a glance.
...
[![X.com](https://img.shields.io/badge/X-black?logo=X.com)](https://github.com/MRTahasaadat)
